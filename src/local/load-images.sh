...
sh "$SCDIR/load-image.sh" "springcloudstream/router-sink-$BROKER_NAME" "$STREAM_APPS_VERSION"
sh "$SCDIR/load-image.sh" "springcloudstream/analytics-sink-$BROKER_NAME" "$STREAM_APPS_VERSION"
sh "$SCDIR/load-image.sh" "springcloudstream/time-source-$BROKER_NAME" "$STREAM_APPS_VERSION"
