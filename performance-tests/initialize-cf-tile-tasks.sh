...
get_app_properties() {
  ...
  [[ -z "$ORG_SPRINGFRAMEWORK_CLOUD_DATAFLOW_TASK_PERFORMANCE_ADD_TASK_EXECTIONS" ]] &&  ORG_SPRINGFRAMEWORK_CLOUD_DATAFLOW_TASK_PERFORMANCE_ADD_TASK_EXECTIONS=true
...
- name: $TASK_NAME
  ...
  env:
    ...
    ORG_SPRINGFRAMEWORK_CLOUD_DATAFLOW_TASK_PERFORMANCE_ADD_TASK_EXECTIONS: $ORG_SPRINGFRAMEWORK_CLOUD_DATAFLOW_TASK_PERFORMANCE_ADD_TASK_EXECTIONS
