...
class TestConfigProperties(unittest.TestCase):
    ...
    def test_env_present_test_config(self):
        test_config = ConfigurationProperties.from_env_vars(env={'DATAFLOW_VERSION': '2.10.4-SNAPSHOT',
                                                               'SKIPPER_VERSION': '2.10.4-SNAPSHOT',
                                                               'DEPLOY_WAIT_SEC': '60',
                                                               'MAX_RETRIES': '10'})
...
def standalone_test_env():
    return {'DATAFLOW_VERSION': '2.10.4-SNAPSHOT',
