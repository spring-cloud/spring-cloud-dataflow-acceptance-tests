...
wget -qO- ${SERVER_URI}/apps/sink/dataflow-tasklauncher/$DATAFLOW_VERSION --post-data="uri=maven://org.springframework.cloud:spring-cloud-dataflow-tasklauncher-sink-$BINDER:$DATAFLOW_VERSION"
