...
public class DataflowServerPostgresBootstrapTests extends AbstractDataflowTests {
	...
	@DockerCompose(id = "dataflow", order = 2, locations = { "src/test/resources/dataflow/dataflow17xpostgres.yml" }, services = { "dataflow" })
	...
	@DockerCompose(id = "dataflow", order = 2, locations = { "src/test/resources/dataflow/dataflow20xpostgres.yml" }, services = { "dataflow" })
