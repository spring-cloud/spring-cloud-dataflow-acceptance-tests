...
NOTE: Currently these shell scripts are used only to test Cloud Foundry environments, K8s acceptance tests use GH Actions in the https://github.com/spring-cloud/spring-cloud-dataflow[spring-cloud-dataflow] repository. The java test code here is used by the K8s build as will. 

== Current status
image::https://github.com/github/docs/actions/workflows/acceptance-tests-for-rabbit-0.yml/badge.svg[link="https://github.com/github/docs/actions/workflows/acceptance-tests-for-rabbit-0.yml", title="rabbit-env-0"]
